...
<section class="hero-section text-center" style="position: relative; padding: 100px 0;">
    <div class="container" style="position: relative; z-index: 1; color: white; background-color: #6d6d6d50;; border-radius: 10px; padding: 40px;">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="event_date" id="event_date" class="form-control" required min="{{ date('d/m/Y') }}" value="{{ old('event_date') }}">
                        @error('event_date')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
